...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <SheetClose className="absolute right-4 top-4 rounded-full p-1.5 text-warm-grey hover:text-charcoal hover:bg-taupe transition-colors">
        <X className="h-5 w-5" />
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn("font-display text-xl font-normal text-charcoal", className)}
    {...props}
  />
));
